...
python classify.py -t -p 0.1 --trainfile train.json -a multinomialnb
...
python classify.py --trainfile train.json --testfile test.json -a multinomialnb -o output.csv
"""
